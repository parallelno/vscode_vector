...
; intended as a comprehensive, mnemonic-based test (one or more lines
; per opcode form). It starts at 0x0100 so labels/addresses are stable.
...
; -------------------------
; Misc examples and repeated items to ensure assembler coverage
LXI H,0x8000
MOV M,A
STA 0x0100
LDA 0x0100
